...
/**
 * KafedralarSearch represents the model behind the search form of `app\models\Kafedralar`.
 */
class KafedralarSearch extends Kafedralar
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['nomi', 'fakultet_id', 'mudir_fio'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'nomi', $this->nomi])
            ->andFilterWhere(['like', 'mudir_fio', $this->mudir_fio])
